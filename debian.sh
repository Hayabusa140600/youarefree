...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome Kanggacor Tunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green} Lunatic® ${NC}${YELLOW}(${NC} ${green} LunaticTunnel ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Kanggacor Tunneling${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/YinnVpn"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/channel_fighunnell/25"}]]}'
